...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">update Kategori</h5>
            <form class="row g-3" method="POST" action="{{ route('kategori.update', $kategori->id) }}">
                ...
                <div class="col-md-4x">
                    ...
                    <div class="col-md-4x">
                        ...
                        <div class="col-md-4x">
                            <label for="input13" class="form-label">Decription</label>
                            <div class="position-relative input-icon">
                                <input type="text" name="deskripsi" class="form-control @error('deskrpsi') is-invalid @enderror" id="input13" value="{{ old('deskrpsi') }}" placeholder="Full deskrpsi" required>
                                <span class="position-absolute top-50 translate-middle-y"><i class="material-icons-outlined fs-5">person_outline</i></span>
                                @error('deskrpsi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
