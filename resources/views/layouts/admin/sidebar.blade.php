<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-semibold ms-2">DigitalDimension</span>
      </a>
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item active">
            <a href="{{url('admin/kategori')}}" class="menu-link">
              <div data-i18n="Analytics">Cagories</div>
            </a>
          </li>
          <li class="menu-item active">
          ...
          <li class="menu-item active">
            <a href="{{url('admin/order_item')}}" class="menu-link">
              <div data-i18n="Analytics">Order Item</div>
            </a>
          </li>
          <li class="menu-item active">
